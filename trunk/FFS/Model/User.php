...
class User {
    ...
    /**
     * send_mail
     * sendet eine Email von der Standardadresse zum Benutzer
     * @tutorial nur vom angegebenen Server moeglich, nicht lokal
     * 
     * @param <type> $subject Betreffzeile
     * @param <type> $message Nachricht
     */
    public function send_mail($subject, $message) {
        $sender_email = Config::emailSenderAdresseServer();
